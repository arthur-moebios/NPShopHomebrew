...
namespace npshop::ui::menu::themezer {
namespace {

// format is /themes/npshop/Theme Name by Author/theme_name-type.nxtheme
constexpr fs::FsPath THEME_FOLDER{"/themes/npshop/"};
constexpr auto CACHE_PATH = "/switch/npshop/cache/themezer";
...
auto InstallTheme(ProgressBox* pbox, const PackListEntry& entry) -> Result {
    static const fs::FsPath zip_out{"/switch/npshop/cache/themezer/temp.zip"};
