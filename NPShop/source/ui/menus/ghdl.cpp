...
namespace npshop::ui::menu::gh {
namespace {

constexpr auto CACHE_PATH = "/switch/npshop/cache/github";
...
auto DownloadApp(ProgressBox* pbox, const GhApiAsset& gh_asset, const AssetEntry* entry) -> Result {
    static const fs::FsPath temp_file{"/switch/npshop/cache/github/ghdl.temp"};
...
void Menu::Scan() {
    ...
    LoadEntriesFromPath("/config/npshop/github/");
    Sort();
    SetIndex(0);
}
