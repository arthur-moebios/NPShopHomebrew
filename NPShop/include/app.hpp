...
// private:
    static constexpr inline auto CONFIG_PATH = "/config/npshop/config.ini";
    static constexpr inline auto PLAYLOG_PATH = "/config/npshop/playlog.ini";
    ...
    bool m_is_launched_via_npshop_forwader{};
